      ...
      <FormProvider {...methods}>
        <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-4">
          ...
          >
            ...
            {/* Street Input */}
            <motion.div variants={itemVariants} className="space-y-1">
              <InputErrorUp isError={errors.state} message={errors.state?.street} label="street" />
              <div className="relative">
            ...
            {/* State Select */}
            <motion.div variants={itemVariants} className="space-y-1">
              <InputErrorUp isError={errors.state} message={errors.state?.state} label="state" />
              <div className="relative">
                <select
                  {...register('state')}
            ...
            <motion.div variants={itemVariants} className="space-y-1">
              {/* label & error */}
              <InputErrorUp isError={errors.state} message={errors.state?.city} label="city" />
              <div className="relative">
                <select
                  {...register('city')}
